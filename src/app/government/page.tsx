      ...
      <section className="relative px-6 pt-24 pb-12 md:pt-36 md:pb-20 overflow-hidden bg-gradient-to-b from-slate-50 via-indigo-50/20 to-white dark:from-brand-navy-950 dark:via-brand-navy-900 dark:to-brand-navy-950 border-b border-slate-200/50 dark:border-white/5">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          >
            ...
            <span className="text-[10px] font-black tracking-[0.2em] text-amber-600 dark:text-amber-400 uppercase">Official Procurement Resource</span>
          </motion.div>
          ...
          >
            ...
            <span className="italic text-brand-blue-600 dark:text-brand-blue-400">Contracting Hub.</span>
          </motion.h1>
          ...
          >
            <Link href="/government/capabilities-statement" className="inline-flex items-center gap-3 bg-brand-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full font-bold transition-all shadow-lg shadow-brand-blue-600/15 hover:-translate-y-1 uppercase tracking-widest text-[11px]">
