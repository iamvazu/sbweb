...
const digitalServices = [
  ...
  { icon: BrainCircuit, title: "Strategic Bid & Procurement Management", desc: "Navigating deep procurement complexity with high-precision bidding and RFP support led by Roy Krautstrunk.", href: "/services/strategic-bid-advisory", image: "/images/services/bid-management.png" },
    ...
    <div className="flex flex-col min-h-screen bg-white dark:bg-black/20">
      ...
      <section className="relative px-6 pt-24 pb-12 md:pt-36 md:pb-20 overflow-hidden bg-gradient-to-b from-slate-50 via-indigo-50/20 to-white dark:from-brand-navy-950 dark:via-brand-navy-900 dark:to-brand-navy-950 border-b border-slate-200/50 dark:border-white/5">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          >
            <Briefcase className="w-3.5 h-3.5 text-brand-blue-600 dark:text-brand-blue-400" />
          ...
          >
            ...
            <span className="italic text-brand-blue-600 dark:text-brand-blue-400">Contracting Capabilities.</span>
          </motion.h1>
