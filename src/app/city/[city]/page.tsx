    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative px-6 pt-24 pb-12 md:pt-36 md:pb-20 overflow-hidden bg-brand-navy-900 border-b border-white/5">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <Link href="/service-areas" className="inline-flex items-center gap-2 text-slate-400 hover:text-white mb-8 transition-colors font-bold tracking-wide uppercase text-[10px]">
          ...
          >
            <ShieldCheck className="w-4 h-4" /> City Verified: {city.name}
          </motion.div>
          ...
          >
            ...
            <span className="text-brand-blue-600">in {city.name}</span>
          </motion.h1>
