...
export const metadata: Metadata = {
  title: "Winning Proposal Template | STRONGERbuilt",
  description: "Structure your narrative for maximum impact. Download our free winning proposal template.",
};
      ...
      <div className="container px-4 md:px-6 max-w-3xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            A structured outline to make your executive summary and technical volume stand out to evaluators.
          </p>
        </div>

        <div className="bg-card border rounded-2xl p-8 shadow-sm">
          <h2 className="text-xl font-bold mb-4">Where should we send your template?</h2>
